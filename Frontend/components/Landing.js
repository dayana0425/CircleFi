  ...
  return (
    ...
    <div>
      ...
      <div className="my-12 mx-64">
        <h1 className="text-3xl tracking-tight font-semibold text-gray-600">
          Savings Circles on the Blockchain
        </h1>
        <div className="mt-4 text-m text-gray-600">
          ...
          friends and family help eachother save for short-term goals. Members
          of a savings circle agree to equally contribute money to a collective
          fund on a regular basis. A member is selected to receive the full
          amount, which continues on a rotating basis until every member has had
          a chance to receive the full amount. We at CircleFi have made a new
          twist to savings circles by allowing savers across the world to
          organize over the internet, while leveraging Web 3 blockchain
          technology to create a safer and more secure savings circle for the
          modern age.
        </div>
      </div>
      {/* <div className="my-12 mx-64">
